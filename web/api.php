...
$app->get('/toilettes/{x}/{y}/{xrang}/{yrang}/{minres}/{maxres}', function ($request, $response, $args) {
	$wc = getToilettes($args['x'], $args['y'], $args['xrang'], $args['yrang'], $args['minres'], $args['maxres']);
	$res = json_encode($wc);
